    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto">
                <a class="nav-link <?= $title === "Dashboard" ? "active" : "" ?>" aria-current="page" href="admin.php"><i class="fa-solid fa-house"></i> dashboard</a>
                <a class="nav-link <?= $title === "Events" ? "active" : "" ?>" href="events.php"><i class="fa-regular fa-calendar-check"></i> Events</a>
