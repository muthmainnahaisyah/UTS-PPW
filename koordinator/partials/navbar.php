    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto">
                <a class="nav-link <?= $title === "Dashboard" ? "active" : "" ?>" aria-current="page" href="koordinator.php"><i class="fa-solid fa-house"></i> dashboard</a>
                <a class="nav-link <?= $title === "AdminEvent" ? "active" : "" ?>" href="adminevent.php"><i class="fa-solid fa-user"></i> Admin</a>
